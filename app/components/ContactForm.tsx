            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '5px' }}>
              {[1, 2, 3, 4, 5].map((star) => (
                <span
                  ...
                  style={{
                    cursor: 'pointer',
                    fontSize: '32px', // Perbesar ukuran bintang
                    margin: '0 5px', // Tambahkan jarak antar bintang
                    color: star <= rating ? '#FFD700' : '#ccc', // Warna bintang
                    transition: 'transform 0.2s, color 0.2s', // Transisi halus
                  }}
                  onMouseEnter={(e) => (e.currentTarget.style.transform = 'scale(1.2)')} // Efek zoom saat hover
